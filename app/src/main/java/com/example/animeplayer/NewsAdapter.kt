...
class NewsAdapter(private val mainActivity: MainActivity,
                  private val mainHandler: Handler): RecyclerView.Adapter<NewsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.title.setOnClickListener { mainActivity.itemOnClickList(news) }
        holder.image.setOnClickListener { mainActivity.itemOnClickList(news) }
